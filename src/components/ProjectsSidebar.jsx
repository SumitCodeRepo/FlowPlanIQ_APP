...
const ProjectSidebar = () => {
    ...
    const getProjectSubItems = (projectId) => [
        { title: 'Dashboard', icon: SettingsIcon, url: `/projectsDetail?id=${projectId}&tab=settings` },
        { title: 'Batch Info', icon: SettingsIcon, url: `/projectsDetail?id=${projectId}&tab=settings` },
